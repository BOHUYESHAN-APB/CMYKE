enum ProviderKind { llm, visionAgent, realtime, omni, tts, stt }

enum ProviderCapability { vision, audioIn, audioOut, bargeIn, tools }

enum ProviderProtocol { openaiCompatible, ollamaNative, deviceBuiltin }
...
class ProviderConfig {
  ...
  factory ProviderConfig.fromJson(Map<String, dynamic> json) => ProviderConfig(
    ...
    contextWindowTokens: (json['context_window_tokens'] as num?)?.toInt(),
